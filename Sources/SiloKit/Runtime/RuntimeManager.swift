...
public actor RuntimeManager {
    ...
    /// sidecar threw away a COMPLETED ~250 MB download and told the user it couldn't be verified. A genuine
    /// 404 is conclusive and returns immediately; only transport failures get a second chance.
