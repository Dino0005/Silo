...
struct AltLoaderSessionTests {
    ...
    private func tempDir() throws -> URL {
        let url = URL(fileURLWithPath: NSTemporaryDirectory(), isDirectory: true)
            .appendingPathComponent("silo-altsession-\(UUID().uuidString)", isDirectory: true)
    ...
    private func prepare(
        ...
        return await AltLoaderSession(runner: runner).prepare(
            ...
            environment: env, temporaryDirectory: root)
    }
    ...
    @Test func preparesTheWhitelistThenLaunchesTheBundleAndReturnsTheSocket() async throws {
        ...
        #expect(socket.lastPathComponent == "silo-altloader-220.sock")
    ...
    @Test func socketPathIsPerGameAndSanitised() {
        ...
        #expect(AltLoaderSession.socketPath(forGameID: "220", temporaryDirectory: tmp).lastPathComponent
                == "silo-altloader-220.sock")
        ...
        #expect(odd.lastPathComponent == "silo-altloader-a-b-c.sock")
    }
}
